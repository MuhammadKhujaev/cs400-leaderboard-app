...
public class Tree_Placeholder implements IterableSortedCollection<GameRecord> {
    ...
    private List<GameRecord> records = Arrays.asList(
          new GameRecord("speedRoyalty", GameRecord.Continent.EUROPE, 47403,534,120, "640:09:00"),
          new GameRecord("xXxgamer47xXx", GameRecord.Continent.ASIA, 48563,539,130, "956:48:46"),
          new GameRecord("v0idt3mp0", GameRecord.Continent.AFRICA, 42023,434,140, "634:06:42"));
